...
SYSTEM_PROMPT = (
    ...
    "a form (type, type, click Send); a repeated action (5 swipes, 3 scrolls); a "
    "deterministic flow (type query, press Enter, click first result); or act-then-"
    "read by ending the batch with list_interactives, so click, wait, "
    ...
    "a conservative batch costs you nothing. Don't batch when you must read the "
    "page MID-sequence to decide the next step. EXCEPTION: an irreversible step "
